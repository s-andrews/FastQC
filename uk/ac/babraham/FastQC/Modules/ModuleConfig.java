...
public class ModuleConfig {
	...
	public ModuleConfig() {
		// Use default limits file
		parameters = readParams(null);
	}

	public ModuleConfig(File limits_file) {
		// Use the supplied limits file
		parameters = readParams(limits_file);
	}

	private HashMap<String, Double> readParams(File limits_file) {
		...
		try {
			if (limits_file == null) {
				...
				br = new BufferedReader(new FileReader(limits_file));
			}
