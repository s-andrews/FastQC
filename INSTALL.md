...
On unix type OSs FastQC uses a small Python script to start the program so you will need to have
an installation of Python (>=3.7) along with its standard library.  Most linx systems will have 
this by default. If you don't you can install it with your system's package manager (eg apt install 
python3 or dnf install python3).
